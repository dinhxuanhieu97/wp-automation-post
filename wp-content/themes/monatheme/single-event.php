										...
										<ul class="news_ct--maybe-list">
											...
											?>
												<li class="news_ct--maybe-item">
													<a class="news_ct--maybe-link" href="<?php echo get_permalink() ?>"><?php
																														echo
																														get_the_title()
																														?></a>
												</li>
			...
			<section class="post_lq free-slide">
				<div class="container">
					<div class="post_lq--wrap">
						<div class="title-box">
							<h2 class="title-sm2 fw-7 cl-text2 title-main"> <strong><?php echo __('Bài viết', 'monamedia'); ?> </strong> <?php echo __('liên quan', 'monamedia'); ?></h2>
						</div>
